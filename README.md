...
- 📽️ **ᴠɪᴅᴇᴏ sᴜᴘᴘᴏʀᴛ:** sᴛʀᴇᴀᴍ ʏᴏᴜᴛᴜʙᴇ ᴠɪᴅᴇᴏs ᴅɪʀᴇᴄᴛʟʏ ɪɴᴛᴏ ᴠᴏɪᴄᴇ ᴄʜᴀᴛs.
- ⚡ **ᴜʟᴛʀᴀ ꜰᴀsᴛ:** ʙᴜɪʟᴛ ᴡɪᴛʜ ᴘʏᴛɢᴄᴀʟʟs ꜰᴏʀ ᴛʜᴇ sᴍᴏᴏᴛʜᴇsᴛ ᴘᴇʀꜰᴏʀᴍᴀɴᴄᴇ.
- 📜 **ᴀᴅᴠᴀɴᴄᴇᴅ ǫᴜᴇᴜᴇ:** ᴍᴀɴᴀɢᴇ ᴜᴘ ᴛᴏ 300 ᴛʀᴀᴄᴋs ᴡɪᴛʜ ᴀᴜᴛᴏ-ᴘʟᴀʏ sᴜᴘᴘᴏʀᴛ.
- 🛠️ **ɪɴᴛᴇʀᴀᴄᴛɪᴠᴇ UI:** ʙᴇᴀᴜᴛɪꜰᴜʟ ɪɴʟɪɴᴇ ʙᴜᴛᴛᴏɴs ᴀɴᴅ ᴘʀᴏɢʀᴇss ʙᴀʀs.
- 💎 **ʟʏʀɪᴄs ꜰɪɴᴅᴇʀ:** ɢᴇᴛ sᴏɴɢ ʟʏʀɪᴄs ɪɴsᴛᴀɴᴛʟʏ ᴡɪᴛʜ `/lyrics`.
...
| ᴄᴏᴍᴍᴀɴᴅ | ᴅᴇsᴄʀɪᴘᴛɪᴏɴ |
| :--- | :--- |
| `/play` | ᴘʟᴀʏ ᴀ sᴏɴɢ ꜰʀᴏᴍ ʏᴏᴜᴛᴜʙᴇ |
| `/vplay` | ᴘʟᴀʏ ᴀ ᴠɪᴅᴇᴏ ꜰʀᴏᴍ ʏᴏᴜᴛᴜʙᴇ |
| `/pause` | ᴘᴀᴜsᴇ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ sᴛʀᴇᴀᴍ |
| `/resume` | ʀᴇsᴜᴍᴇ ᴛʜᴇ ᴘᴀᴜsᴇᴅ sᴛʀᴇᴀᴍ |
| `/skip` | sᴋɪᴘ ᴛᴏ ᴛʜᴇ ɴᴇxᴛ sᴏɴɢ |
| `/stop` | sᴛᴏᴘ ᴘʟᴀʏʙᴀᴄᴋ & ᴄʟᴇᴀʀ ǫᴜᴇᴜᴇ |
| `/volume` | ᴀᴅᴊᴜsᴛ sᴛʀᴇᴀᴍ ᴠᴏʟᴜᴍᴇ (1-200) |
| `/ping` | ᴄʜᴇᴄᴋ ʙᴏᴛ ʟᴀᴛᴇɴᴄʏ & sᴛᴀᴛᴜs |
| `/queue` | ᴠɪᴇᴡ ᴜᴘᴄᴏᴍɪɴɢ ᴛʀᴀᴄᴋs |
| `/lyrics` | sᴇᴀʀᴄʜ ꜰᴏʀ sᴏɴɢ ʟʏʀɪᴄs |
...
1. ꜰᴏʀᴋ ᴛʜɪs ʀᴇᴘᴏ.
2. ᴄʟɪᴄᴋ ᴛʜᴇ **ᴅᴇᴘʟᴏʏ ᴏɴ ʀᴀɪʟᴡᴀʏ** ʙᴜᴛᴛᴏɴ ᴀʙᴏᴠᴇ.
3. ꜰɪʟʟ ɪɴ ʏᴏᴜʀ ᴇɴᴠ ᴠᴀʀɪᴀʙʟᴇs (`API_ID`, `API_HASH`, `BOT_TOKEN`, `SESSION_STRING`).
4. **ᴇɴᴊᴏʏ ᴛʜᴇ ᴍᴜsɪᴄ!**
